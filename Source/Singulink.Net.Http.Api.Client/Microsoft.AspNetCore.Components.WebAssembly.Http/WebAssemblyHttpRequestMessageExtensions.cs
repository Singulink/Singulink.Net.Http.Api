...
/// </summary>
internal static class WebAssemblyHttpRequestMessageExtensions
{
    ...
    private static readonly HttpRequestOptionsKey<bool> WebAssemblyEnableStreamingRequestKey = new("WebAssemblyEnableStreamingRequest");
    private static readonly HttpRequestOptionsKey<bool> WebAssemblyEnableStreamingResponseKey = new("WebAssemblyEnableStreamingResponse");
